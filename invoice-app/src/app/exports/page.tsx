    ...
    <main className="mx-auto w-full max-w-6xl px-6 py-10">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-semibold">Export Approved Invoices</h1>
        </div>
        <div className="flex gap-3 text-sm">
          <Link className="underline" href="/exceptions">
            Exceptions
          </Link>
      ...
      <div className="mb-4 rounded-xl border border-black/10 bg-white p-4">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <p className="text-sm text-zinc-600">{selectedCount} selected</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.3fr_0.9fr]">
        <section className="rounded-xl border border-black/10 bg-white p-4">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold">Approved Invoices</h2>
                    ...
                    onChange={(event) => {
                      setSelectedIds((current) =>
                        event.target.checked
                          ...
                          : current.filter((id) => id !== invoice.invoice_id),
                      );
                    }}
                    type="checkbox"
                  />
            ...
            {history.length === 0 ? (
              ...
              history.map((record) => (
                <div
                  ...
                  className="rounded-lg border border-black/10 bg-zinc-50 p-3 text-sm"
                >
